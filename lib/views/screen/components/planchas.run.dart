...
class PlanchasRunScreen extends StatefulWidget {
  const PlanchasRunScreen({super.key});

  @override
  State<PlanchasRunScreen> createState() => _PlanchasRunScreenState();
}

class _PlanchasRunScreenState extends State<PlanchasRunScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CardRunLineInfoView(
                          srmImage: "assets/apps/planchas.gif",
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        CardRunLineInfoView(
                          srmImage: "assets/apps/planchas_2.gif",
                        )
                      ],
                    )
                  ],

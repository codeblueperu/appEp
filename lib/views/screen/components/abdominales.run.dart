...
class AbdominalesRunScreen extends StatefulWidget {
  const AbdominalesRunScreen({super.key});

  @override
  State<AbdominalesRunScreen> createState() => _AbdominalesRunScreenState();
}

class _AbdominalesRunScreenState extends State<AbdominalesRunScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CardRunLineInfoView(
                          srmImage: "assets/apps/abdominales.gif",
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        CardRunLineInfoView(
                          srmImage: "assets/apps/abdominales_2.gif",
                        )
                      ],
                    )
                  ],
